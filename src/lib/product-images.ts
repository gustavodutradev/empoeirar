...
const productImages: Record<string, string[]> = {
  ...
  "conjunto-carai": ["Carai 1.png", "Carai 2.png", "Carai 3.png"],
  ...
  coracoes: ["Coracoes 1.png", "Coracoes 2.png", "Coracoes 3.png", "Coracoes 4.png"],
  ...
  "disco-com-miolo-removivel-para-torno": [
    "Discos Para Torno com Miolo Removivel 1.png",
    "Discos Para Torno com Miolo Removivel 2.png",
    "Discos Para Torno com Miolo Removivel 3.png",
    "Discos Para Torno com Miolo Removivel 4.png",
  ],
  ...
  "limao-siciliano": [
    "Limao Siciliano 1.png",
    "Limao Siciliano 2.png",
    "Limao Siciliano 3.png",
    "Limao Siciliano 4.png",
  ],
  luas: ["Luas 1.png", "Luas 2.png", "Luas 3.png", "Luas 4.png"],
  maca: ["Maca 1.png", "Maca 2.png", "Maca 3.png", "Maca 4.png"],
